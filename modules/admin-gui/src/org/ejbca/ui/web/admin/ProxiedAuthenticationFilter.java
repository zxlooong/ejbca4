 ...
 * 
 * @version $Id: ProxiedAuthenticationFilter.java 15009 2012-06-18 12:49:30Z primelars $
 */
			...
			if (proxiedAuthenticationEnabled) {
				...
				if (username != null) {
					...
					if (tempCerts[0] == null) {
	                    ...
	                    final Admin admin = ejb.getUserAdminSession().getAdmin(tempCerts[0]);
	                    if (ejb.getAuthorizationSession().isAuthorizedNoLog(admin, AccessRulesConstants.ROLE_SUPERADMINISTRATOR)) {
