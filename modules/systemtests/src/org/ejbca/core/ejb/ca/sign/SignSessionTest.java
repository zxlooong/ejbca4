 ...
 * 
 * @version $Id: SignSessionTest.java 12407 2011-08-31 07:45:35Z anatom $
 */
public class SignSessionTest extends CaTestCase {
    ...
    public void test27IssuanceRevocationReason() throws Exception {
        ...
        try {
            ...
            // Change already existing user
            UserDataVO user = new UserDataVO(username, "C=SE,O=AnaTom,CN=foorevreason", rsacaid, null, null, SecConst.USER_ENDUSER, pid, SecConst.CERTPROFILE_FIXED_ENDUSER,
                    SecConst.TOKEN_SOFT_PEM, 0, null);
            user.setPassword("foo123");
            userAdminSession.addUser(admin, user, false);
            ...
            userAdminSession.changeUser(admin, user, false);
            userAdminSession.setUserStatus(admin, username, UserDataConstants.STATUS_NEW);
            UserDataVO udata = userAdminSession.findUser(admin, username);
...
//        System.out.println(cert);
    ...
    public void test38UniqueSubjectDN() throws Exception {
        ...
        try {
            ...
            // Change already existing user
            UserDataVO user1 = new UserDataVO(username1, "CN=foounique,O=PrimeKey,C=SE", rsacaid, null, null, SecConst.USER_ENDUSER, pid, SecConst.CERTPROFILE_FIXED_ENDUSER,
                    SecConst.TOKEN_SOFT_PEM, 0, null);
            ...
            UserDataVO user2 = new UserDataVO(username2, "CN=foounique,O=PrimeKey,C=SE", rsacaid, null, null, SecConst.USER_ENDUSER, pid, SecConst.CERTPROFILE_FIXED_ENDUSER,
                    SecConst.TOKEN_SOFT_PEM, 0, null);
            ...
            userAdminSession.setUserStatus(admin, username1, UserDataConstants.STATUS_NEW);
            UserDataVO udata = userAdminSession.findUser(admin, username1);
            ...
            userAdminSession.setUserStatus(admin, username2, UserDataConstants.STATUS_NEW);
            udata = userAdminSession.findUser(admin, username2);
            assertEquals("CN=foounique,OU=,OU=FooOU,O=PrimeKey,C=SE", udata.getDN());
            assertEquals("CN=foounique,OU=FooOU,O=PrimeKey,C=SE", udata.getCertificateDN());
            // Create cert again
            try {
